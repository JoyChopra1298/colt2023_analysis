...
from constants.file_names import RAW_DATA_FILE_PATH, STRUCTURED_DATA_FILE_PATH
...
def extract_paper_data(paper_id, raw_data):
    ...
    for author_raw_data in author_raw_data_list:
        ...
        author_data = {
            "author_name": author_data_split_list[1].strip(),
            "affiliation_name": author_data_split_list[2].strip()
        }
